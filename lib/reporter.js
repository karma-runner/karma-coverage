      ...
      browsers.forEach(function(browser) {
        ...
        if (collector) {
          ...
          helper.mkdirIfNotExists(out, function() {
            var reportTypes = (typeof reporterConfig.type === 'string') ? [reporterConfig.type] : reporterConfig.type;

            (reportTypes || ['html']).forEach(function(reportType) {
              ...
              if (reportType !== 'text' && reportType !== 'text-summary') {
                delete options.file;
              }
